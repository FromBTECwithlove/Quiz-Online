...
<head>
  ...
  <style type="text/css">
    ...
    .answer-form span,input,textarea,p{
      font-size: 16px !important;
    }
    .answer-form span{
      margin-top: 5px;
  ...
  <body>
    <div class="modal fade" id="add-ques" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="add-container">
              ...
              <div class="form-container">
                <div class="hidden-form-container">
                  <form class="item" id="btn-single-choice" action="add_question.php" method="POST" accept-charset="utf-8">
                    <div class="hidden-form">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="cate_id">
                          ...
                          $sql = mysqli_query($conn, "SELECT * FROM category WHERE cate_id = '".$_REQUEST['cate_id']."'");
                          while($row = mysqli_fetch_array($sql)){?>
                            <option value="<?php echo $row['cate_id']; ?>" selected hidden><?php echo $row['cate_title']; ?></option>
                          <?php }?>
                        </select>
                      </div>
                ...
                <!-- True/False -->
                <div class="hidden-form-container">
                  <form class="item" id="btn-true-false" action="add_question.php" method="POST" accept-charset="utf-8">
                    <div class="hidden-form">
                      <div class="form-group">
                        <p>Category</p>
                        <select class="form-control" name="cate_id">
                ...
                <!-- Multiple Choices -->
                <div class="hidden-form-container">
                  <form class="item" id="btn-multiple-choice" action="add_question.php" method="POST" accept-charset="utf-8">
                    <div class="hidden-form">
                      <div class="form-group">
                        <p>Category</p>
                        <select class="form-control" name="cate_id">
